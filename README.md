...
[![Coverage Status](https://coveralls.io/repos/github/matheusquintaes/Spotify-Wrapper/badge.svg?branch=master)](https://coveralls.io/github/matheusquintaes/Spotify-Wrapper?branch=master)
...
import { method } from 'spotify-wrapper-js';

// to import everything
import * as spotifyWrapper from 'spotify-wrapper-js';
```

### CommonJS

```js
var spotifyWrapper = require('spotify-wrapper-js');
```
...
## Authors
| ![Matheus Quintaes](https://avatars0.githubusercontent.com/u/8750294?s=460&v=4)|
|:---------------------:|
|  [Matheus Quintaes](https://github.com/matheus.quintaes/)   |

<!-- See also the list of [contributors](https://github.com/matheusquintaes/spotify-wrapper/contributors) who participated in this project. -->
